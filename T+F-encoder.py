...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mMD.FAIJUL\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> H4X0R      ║  \033[1;97m
╠══[Github:=======================> \33[1;38mMdfaijul01      ║\33[1;34m
╠══[Whatsapp:=====================> 01846201363     ║\33[1;35m
...
def obfuscate(VARIABLE_NAME, file_content):
    ...
    for _ in range(int(len(b64_content) / OFFSET) + 1):
        ...
        index += OFFSET
    code += f'exec(__import__("\\x62\\x61\\x73\\x65\\x36\\x34").b64decode({VARIABLE_NAME}.encode("T_F/HACKER/T_F/HACKER")).decode("T_F/HACKER/T_F/HACKER"))'
    return code
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        filedata = temp_f.read()
        out_f.write("# Encrypted by: H4X0R (FAIJUL) \n# Whatsapp: +8801846201363\n# Github: https://github.com/Mdfaijul01\n\n"+filedata)
    os.remove(".temp")
    sprint(success + out_file + " saved in "+pwd)
    mover(out_file)
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system('xdg-open --view  https://www.facebook.com/your.dad.official.12')
                ret=input(white+"\nENTER TO BACK > "+green)
            main()    
   #         else:
    #   os.system('xdg-open  https://www.facebook.com/your.dad.official.12')
